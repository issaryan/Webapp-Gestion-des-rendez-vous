...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RENDEZVOUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RENDEZVOUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RENDEZVOUS actions', async () => {
      const arg = { id: 6733 };
    ...
    it('dispatches UPDATE_RENDEZVOUS actions', async () => {
      const arg = { id: 6733 };
    ...
    it('dispatches PARTIAL_UPDATE_RENDEZVOUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RENDEZVOUS actions', async () => {
      const arg = 42666;
