...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './medecin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDECIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDECIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDECIN actions', async () => {
      const arg = { id: 27086 };
    ...
    it('dispatches UPDATE_MEDECIN actions', async () => {
      const arg = { id: 27086 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDECIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDECIN actions', async () => {
      const arg = 42666;
