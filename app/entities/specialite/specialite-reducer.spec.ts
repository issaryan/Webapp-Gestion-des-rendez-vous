...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALITE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALITE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALITE actions', async () => {
      const arg = { id: 22547 };
    ...
    it('dispatches UPDATE_SPECIALITE actions', async () => {
      const arg = { id: 22547 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALITE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALITE actions', async () => {
      const arg = 42666;
